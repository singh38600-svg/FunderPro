...
function Dashboard({setPage}){
  ...
  <div className="notice">This independent dashboard uses fictional account data and is not affiliated with or operated by FunderPro.</div>
  </>
}
